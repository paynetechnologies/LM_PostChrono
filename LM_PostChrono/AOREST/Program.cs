...
namespace AORest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // this is equivalient to: ERS ers = new ERS(container) but uses Constructor Injection...
            ERS ers = container.Resolve<ERS>(); 

            //ers.TestSuccess();
            ers.TestFailure();          // create a failed chronos used for TestRetry
            //ers.TestRetry();

            //ers.TestGetStaffName();
            //ers.TestGetPactsType();
            //ers.TestAuthorCode();         // Uses Template Services
